...
class SlaveController :
    ...
    def start(self,master_ip):
        ...
        getNohupID = subprocess.Popen(["nohup "+spark_home+"/bin/spark-class org.apache.spark.deploy.worker.Worker spark://"+master_ip+":7077 -c 1 > /dev/null 2>&1 & echo $!"], stdout=subprocess.PIPE, shell=True)
